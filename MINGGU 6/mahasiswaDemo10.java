public class mahasiswaDemo10 {
    public static void main(String[] args) {
        ...
        System.out.println("\nData mahasiswa setelah sorting berdasarkan IPK (descending):");
        list.bubbleSort();
        list.tampil();
        
        System.out.println("\nData mahasiswa setelah sorting menggunakan selection sort berdasarkan IPK (ascending):");
        list.SelectionSort();
        list.tampil();
        
        System.out.println("\nData mahasiswa setelah sorting menggunakan insertion sort berdasarkan IPK (ascending):");
        list.insertionSort();
        list.tampil();
    }
}
